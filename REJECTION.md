...
**Action Required:** Please cancel the recurring 'Mission' session in the Jules web UI (tracked as IAN-398) to prevent these tasks from being automatically generated daily. Auto-closing IAN-398 via branch-name coincidence is not a real fix and the underlying session remains unresolved.
