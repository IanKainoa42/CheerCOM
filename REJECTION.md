...
Note: Auto-closing via branch-name coincidence (e.g., matching 'IAN-398') does not actually cancel the session in the Jules UI and is not a real fix to prevent daily generation.
