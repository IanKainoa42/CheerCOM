...
**Action Required:** Please cancel the recurring 'Mission' session in the Jules web UI (tracked as IAN-398) to prevent these tasks from being automatically generated daily. Auto-closing this issue via branch-name coincidence is not a real fix to prevent daily generation; human intervention is required to stop the session directly.
