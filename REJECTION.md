...
Note: Auto-closing via branch-name coincidence is not a real fix to prevent daily generation. The recurring 'Mission' session must be cancelled directly at jules.google.com (IAN-398). This mitigation for vague-scope recurring sessions is tracked under IAN-484.
