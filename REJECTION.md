...
**Action Required:** Please cancel the recurring 'Mission' session in the Jules web UI (tracked as IAN-398) to prevent these tasks from being automatically generated daily. Note that auto-closing via branch-name coincidence is not a real fix and does not cancel the underlying session.
