...
**Action Required:** Please cancel the recurring 'Mission' session directly in the Jules web UI at jules.google.com (tracked as IAN-398) to prevent these tasks from being automatically generated daily. Note that auto-closing issues via branch-name coincidence is not a real fix to prevent daily generation.
