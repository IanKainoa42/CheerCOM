...
This rejection is tracked as part of the mitigation for the vague-scope recurring session (see IAN-484), enforcing the repository's strict task scope requirements.
