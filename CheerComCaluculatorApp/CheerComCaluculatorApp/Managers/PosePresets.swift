    ...
    func getPose(_ type: PoseType) -> PoseDefinition {
        ...
        case .layout:
            return PoseDefinition(
                ...
                category: .fullBody,
                jointAngles: [
                    "mixamorig_Spine": SCNVector3(deg(5), deg(0), deg(0)),
                    "mixamorig_Spine1": SCNVector3(deg(5), deg(0), deg(0)),
                    "mixamorig_Spine2": SCNVector3(deg(5), deg(0), deg(0)),
                    "mixamorig_RightArm": SCNVector3(deg(0), deg(0), deg(-180)),
                    "mixamorig_LeftArm": SCNVector3(deg(0), deg(0), deg(180)),
                    "mixamorig_RightUpLeg": SCNVector3Zero,
                    "mixamorig_LeftUpLeg": SCNVector3Zero,
                ],
                description: "Straight body with slight arch and arms overhead"
            )
