...
class JointLimits {
    static let limits: [String: JointLimit] = [
        ...
        // Neck
        "mixamorig_Neck": JointLimit(minX: -60, maxX: 60, minY: -90, maxY: 90, minZ: -45, maxZ: 45),

        // Hips
        "mixamorig_RightUpLeg": JointLimit(minX: -180, maxX: 90, minY: -90, maxY: 90, minZ: -90, maxZ: 90),
        "mixamorig_LeftUpLeg": JointLimit(minX: -180, maxX: 90, minY: -90, maxY: 90, minZ: -90, maxZ: 90),

        // Shoulders
        "mixamorig_RightArm": JointLimit(minX: -180, maxX: 180, minY: -180, maxY: 180, minZ: -180, maxZ: 45),
        "mixamorig_LeftArm": JointLimit(minX: -180, maxX: 180, minY: -180, maxY: 180, minZ: -45, maxZ: 180)
    ]
